              ...
              return (
                <motion.button
                  ...
                  className={`relative w-full rounded-2xl border p-6 text-left transition-all duration-300 ${
                    isSelected
                      ? "bg-zinc-950 border-indigo-500/40 shadow-[0_0_40px_-10px_rgba(99,102,241,0.3)]"
                      : "bg-zinc-950/50 border-white/[0.08] hover:border-indigo-500/40"
                  }`}
                >
                  ...
                  {isSelected && (
                    <motion.div
                      ...
                      className="pointer-events-none absolute inset-0 rounded-2xl border border-indigo-500/40"
                    />
                  )}
                </motion.button>
              );
